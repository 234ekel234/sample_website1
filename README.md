...
| `member-and-donor-guide-deck.md` | Slide-by-slide source for a "how to join / how to give" deck |
| `information-request-email.md` | What is still needed from PMAFI, split by Finance / Admin / Membership |
