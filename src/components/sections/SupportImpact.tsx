    ...
    <section className="relative overflow-hidden bg-[#0a1628] py-24" ref={ref}>
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        >
          <Link
            href="/donate"
            className="group inline-flex items-center gap-2 rounded-lg bg-[#C8A951] px-7 py-3 text-sm font-semibold text-[#0a1628] shadow-[0_8px_30px_-8px_rgba(200,169,81,0.6)] transition-all hover:bg-[#8A6A22] hover:text-white"
          >
            Support the Mission
